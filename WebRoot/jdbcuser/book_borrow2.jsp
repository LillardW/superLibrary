...
while(rs1.next()) {a=rs1.getString("BkID");}
              if(a.equals("0")){out.print("您来晚一步!图书已被预约!请另行挑选");} else{ out.print("您所借的图书库存号为："+a+"<br>");
                String sql1 = "update book set BON=2 where BkID='"+a+"';";
//out.print(sql1);
...
//pstmt.setString(1,a);
				String sqlinsert = "insert into borrow2(BookId,BkID,ReaderID,BorrowDate,ReturnDate,Memo) values(?,?,?,?,?,?)";
